...
/*
Here's what happend behind the scenes when the new keyword
is used:
...
The construtor is called: The construtor function is 
...
hass been called, if it doesn't return a non- primitive value
(object, array, function, etc.), the newly craeted object
is returned.
